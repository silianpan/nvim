...
--     function()
-- nvim-lspinstall过时了，改用nvim-lsp-installer
...
-- nvim-lspinstall插件配置 begin
-- local servers = require'nvim-lsp-installer'.installed_servers()
...
-- end
-- setup_servers()
-- nvim-lspinstall插件配置 end

-- nvim-lsp-installer插件配置 begin
